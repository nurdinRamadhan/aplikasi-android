...
import com.alhasanah.alhasanahmedia.showcase.model.MsgAnimation
import com.alhasanah.alhasanahmedia.showcase.model.ShowcaseMsg
import com.alhasanah.alhasanahmedia.showcase.model.TargetShape
...
fun TargetShowcaseLayout(
    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        if (isShowcasing || showCasingItem || isSingleGreeting) {
            ...
            var canvasColor =  message?.msgBackground ?: Color.Black.copy(alpha = 0.1f)
            ...
            LaunchedEffect(currentIndex) {
                ...
                if (currentIndex == 0 || currentIndex == validatedInitIndex) {
                    ...
                    canvasColor =  message?.msgBackground ?: Color.Black.copy(alpha = 0.1f)
            ...
            Canvas(
                ...
                if (isSingleGreeting || currentIndex == 0) {
                    ...
                    drawRect(
                        color = canvasColor.copy(alpha = 0.1f),
                        size = size,
                ...
                if (currentIndex == validatedInitIndex){
                    drawPath(
                        path = donutPath,
                        color = canvasColor.copy(alpha = 0.1f * canvasAlpha.value),
                        style = Fill // Fill the donut shape
                    )
                }else{
                    drawPath(
                        path = donutPath,
                        color = canvasColorAnimated.copy(alpha = 0.1f * canvasAlpha.value),
                        style = Fill // Fill the donut shape
                    )
                }
